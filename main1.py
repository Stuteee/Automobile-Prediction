...
try:
    model = pickle.load(open(r'E:\second year\compute\Automobile\pca_model.pkl', 'rb'))
    pca = joblib.load("E:\second year\compute\Automobile\trained_model.pkl")
    st.write("Models loaded successfully!")
except Exception as e:
    st.write(f"Error loading model or PCA: {str(e)}")
...
def main():
    ...
    # Make a Prediction option
        ...
        input_df_encoded = input_df_encoded.reindex(columns=df_combined.columns, fill_value=0)
